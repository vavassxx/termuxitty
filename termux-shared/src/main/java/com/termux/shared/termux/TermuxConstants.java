...
public final class TermuxConstants {
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "Termuxitty"; // Termuxitty fork identity
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.ttymux"; // Default: "com.termux"
    /** Java namespace retained for the fork; Android application identity is TERMUX_PACKAGE_NAME. */
